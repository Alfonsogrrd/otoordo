...
<div class="container">
    <div class="vehicle-title">
        <h1>CX-8</h1>
        <p>Luxury SUV for the Family</p>
    </div>

    <div class="price-section">
        <h3>Starting From Rp 795.000.000</h3>
    </div>

    <div class="vehicle-image" style="text-align: center;">
        <img src="../images/mazda/cx8.png" alt="CX-8" width="400" height="400">
    </div>
    ...
    <div class="spec-section">
        ...
        <div class="spec-item">
            <strong>Safety:</strong> <span>Advanced Safety Features, Rear Cross Traffic Alert</span>
        </div>
    </div>
